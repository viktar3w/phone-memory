              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  <Image
                    ...
                    alt="user one"
                    className="inline-block object-cover rounded-full w-10 h-10 ring-2 ring-state-100"
                    width={10}
                    height={10}
                  />
                  <Image
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <img
                src="/line.png"
                alt="line"
                className="absolute w-20 lg:w-52 -left-6 -bottom-6 select-none"
              />
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:x-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              />
              <div className="relative h-80 ms:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img
                  src="/horse.jpg"
                  alt="horse"
